...
export const enPages = {
	home: {
		title: 'Fortnite Cheats 2026 | Undetected ESP, Aimbot & Wallhack',
		description:
			'Fortnite cheats & fortnite cheats for PC — undetected fortnite esp, wallhack, radar and fortnite aimbot. Compare plans and 2026 EAC updates.',
		h1: 'Fortnite Cheats — Undetected ESP, Wallhack & Aimbot',
		intro:
			'Fortnite Cheats is the undetected fortnite cheats package for Windows PC — also searched as fortnite cheats and fortnite cheat. Fortnite esp wallhack, 2D radar, and fortnite aimbot with EAC maintenance after every major patch.',
		imageAlt: 'fortnite cheats esp',
		...
		sections: [
			section(
				...
				'Fortnite rewards map awareness. Fortnite Cheats combines ESP wallhack for enemy players and loot, radar-style threat cues, and configurable Aimbot so you can read fights before committing — on raid, zero-build, and competitive lobbies.',
				`Official seasons, patches, and anti-cheat updates come from ${EXT.activision} and ${EXT.eac}. We rebuild ESP, radar, and Aimbot modules when those patches require maintenance — then post status on the <a href="/updates/">Updates page</a>.`,
				...
				'Start with the <a href="/fortnite-cheats/">Fortnite cheats pillar</a>, <a href="/fortnite-esp/">ESP guide</a>, <a href="/fortnite-aimbot/">Aimbot controls</a>, and <a href="/undetected-fortnite-cheats/">undetected status</a> pages if you are comparing tools before checkout.',
			),
			section(
				'ESP wallhack, radar hack, and Aimbot in one license',
				'Instead of stacking separate tools, Fortnite Cheats bundles player ESP wallhack, chest markers, 2D radar overlays, and Aimbot profiles in one undetected package built for Battle Royale and Zero Build — covering both fortnite cheats and fortnite cheats search intent.',
				...
				`Before patch days, check ${EXT.status} for Epic Games service health, then confirm our maintenance notes so you are not queueing on an outdated build.`,
	...
	'fortnite-esp': {
		...
		description:
			'Fortnite ESP for Windows PC — player boxes, chest markers, and distance readouts. Part of our undetected fortnite cheats for Fortnite.',
		h1: 'Fortnite ESP — Player Boxes & Wallhack',
		intro:
			'Fortnite esp visibility tools for raid and zero-build. Read enemy squads, vehicles, loot, and distance before you commit — toggleable fortnite esp wallhack overlays bundled in our fortnite cheats package.',
		imageAlt: 'fortnite cheats radar',
		...
		sections: [
			section(
				'What Fortnite ESP solves in matches',
				...
				'On raid, zero-build, and competitive lobbies, that visibility gap is often the difference between a clean third-party and a seasond squad. ESP ships bundled with radar overlays and Aimbot in one license.',
				`Fortnite’s live seasons and map updates are published by ${EXT.activision}. When POIs or loot rules shift, ESP categories stay useful because they track players and containers — not a single static landmark.`,
			),
			section(
				...
				'Distance readouts and snapline options help you control engagement range. Team and enemy colour coding supports Battle Royale and Zero Build lobbies alike.',
			...
			section(
				...
				`Read ${EXT.eac} for how anti-cheat updates ship, then cross-check our <a href="/eac-bypass/">EAC bypass maintenance guide</a> after major patches.`,
	...
	'fortnite-aimbot': {
		...
		description:
			'Fortnite aimbot with soft aim tuning for Windows PC. FOV, bone priority, and hotkeys bundled with ESP boxes in our fortnite cheats package.',
		...
		imageAlt: 'fortnite cheats aimbot',
		...
		sections: [
			...
			section(
				...
				`Cross-check service health on ${EXT.status} and anti-cheat context on ${EXT.eac}, then follow our <a href="/eac-bypass/">EAC maintenance guide</a> before queueing on patch day.`,
	...
	features: {
		title: 'Fortnite Cheats Features | ESP, Soft Aim, ',
		description:
			'Full fortnite cheats feature list: ESP boxes, soft aim, radar, and toggles for Windows PC. Review controls before checkout.',
		...
		sections: [
			section(
				...
				'Team and enemy colour coding supports Battle Royale and Zero Build. Deep-dive the <a href="/fortnite-esp/">ESP page</a> and <a href="/fortnite-wallhack/">wallhack guide</a> for category-level detail.',
	...
	pricing: {
		...
		description:
			'Fortnite cheats pricing: $35/month or $150 lifetime for ESP, soft aim, boxes, and on Windows PC. Instant delivery — pick a plan.',
		...
		sections: [
			...
			section(
				...
				'Player ESP wallhack, chest markers, 2D radar overlays, Aimbot controls, in-client toggles, and maintenance rebuilds after Easy Anti-Cheat or major Fortnite patches.',
	...
	setup: {
		title: 'Fortnite Cheats Setup | PC & Controller Guide',
		description:
			'Set up fortnite cheats on Windows PC — activate ESP boxes, soft aim profiles, and . Check EAC updates before your first queue.',
		h1: 'Fortnite Cheats Setup — PC & Controller Guide',
		intro:
		...
		sections: [
			section(
				...
				`Also glance at ${EXT.status} if Epic Games services look unstable on patch day — a platform outage is not a license fault.`,
			...
			section(
				...
				'Use in-client hotkeys to toggle ESP, radar, and Aimbot mid-match. Details for Easy Anti-Cheat module live on <a href="/fortnite-esp/">ESP</a>, <a href="/fortnite-aimbot/">Aimbot</a>, and <a href="/fortnite-mod-menu/">mod menu</a>.',
			...
			section(
				...
				`Official anti-cheat background: ${EXT.eac}. Our practical workflow is documented on the <a href="/eac-bypass/">EAC bypass page</a> and <a href="/undetected-fortnite-cheats/">undetected guide</a>.`,
				'Contact <a href="/support/">Support</a> with your order ID if activation fails after a patch — include Windows version and error details for faster replies.',
			),
		],
	},
	updates: {
		title: 'Fortnite Cheats Updates | Easy Anti-Cheat Maintenance Log',
		description:
			'Fortnite cheats update log: Easy Anti-Cheat rebuilds for ESP boxes, soft aim, and on Windows PC. Check status before queueing after patches.',
		...
		sections: [
			section(
				...
				`Use ${EXT.status} for Epic Games platform health and this page for Fortnite Cheats build status — both matter on big update days.`,
				'Checking this log before you queue reduces surprises after game days or seasonal launches on raid and zero-build.',
			),
			section(
				...
				'For context on why rebuilds happen, read the <a href="/eac-bypass/">EAC bypass guide</a> and <a href="/undetected-fortnite-cheats/">undetected Fortnite cheats</a> explainer.',
			),
			section(
	...
	faq: {
		title: 'Fortnite Cheats FAQ | ESP, Soft Aim & Easy Anti-Cheat Answers',
		description:
			'Fortnite cheats FAQ: ESP boxes, soft aim, EAC maintenance, and pricing for PC. Clear answers before you buy.',
		...
		sections: [
			section(
				...
				'Packages cover raid and zero-build. Explore <a href="/features/">Features</a> for the full control list and <a href="/fortnite-esp/">ESP</a> / <a href="/fortnite-aimbot/">Aimbot</a> for module detail.',
				`Fortnite itself is published by ${EXT.activision}. Cheats are third-party tools and may violate Epic Games' rules — use is at your own risk.`,
			),
			section(
				...
				'Read <a href="/undetected-fortnite-cheats/">undetected Fortnite cheats</a> and the <a href="/eac-bypass/">Easy Anti-Cheat guide</a> for the maintenance workflow.',
	...
	support: {
		...
		description:
			'Contact fortnite cheats support for licenses, ESP setup, soft aim profiles, and on Windows PC. Include your order ID for faster help.',
		...
		sections: [
			section(
				...
				'REasy Anti-Cheat out for order issues, license activation failures, ESP wallhack or Aimbot setup questions, and post-patch problems after EAC maintenance rebuilds.',
	...
	undetected: {
		title: 'Undetected Fortnite Cheats 2026 | Easy Anti-Cheat Maintenance',
		description:
			'Undetected fortnite cheats with EAC maintenance for ESP boxes, soft aim, and on Windows PC. Check status before you queue.',
		h1: 'Undetected Fortnite Cheats — Easy Anti-Cheat Maintenance',
		intro:
		...
		imageAlt: 'undetected fortnite cheats',
		...
		sections: [
			section(
				...
				`Anti-cheat technology is documented by ${EXT.eac}; Fortnite client updates ship through ${EXT.activision}. Undetected status is an ongoing process tied to those releases.`,
			),
			section(
				...
				'Deep technical workflow: <a href="/eac-bypass/">EAC bypass Fortnite guide</a>. Feature stack: <a href="/features/">Features</a>.',
			),
			section(
	...
	wallhack: {
		...
		description:
			'Fortnite wallhack ESP with player boxes and chest markers for Windows PC. Undetected fortnite cheats with — learn overlays and buy.',
		h1: 'Fortnite Wallhack — ESP Boxes & Visibility',
		intro:
			'Fortnite wallhack ESP for Fortnite — see players, loot, vehicles, and chests through toggleable wallhack overlays built for Battle Royale and Zero Build.',
		imageAlt: 'fortnite cheats wallhack',
		...
		sections: [
			...
			section(
				...
				'Wallhack overlays support raid, zero-build, and competitive lobbies with distance readouts and snaplines for engagement control.',
			...
			section(
				...
				'Learn the full maintenance story on <a href="/undetected-fortnite-cheats/">undetected Fortnite cheats</a> and <a href="/eac-bypass/">EAC bypass</a>.',
	...
	radar: {
		...
		description:
			'Fortnite radar hack for flank awareness on Windows PC. Bundled with ESP boxes, soft aim, and in our fortnite cheats package.',
		...
		sections: [
			...
			section(
				...
				'Adjust radar range for early rotations versus tight endgame circles. Directional cues highlight flanks during building clears and vehicle pushes across raid and zero-build.',
	...
	'eac-bypass': {
		title: 'EAC Bypass Fortnite | Fortnite Cheats Maintenance',
		description:
			'How fortnite cheats rebuild after EAC patches — ESP boxes, soft aim, and maintenance for Windows PC. Read before queueing.',
		...
		sections: [
			section(
				...
				`Fortnite Cheats monitors EAC patch notes and Fortnite seasonal updates from ${EXT.activision} to schedule module reviews.`,
			...
			section(
				...
				`Confirm Epic Games service health on ${EXT.status} if the launcher or matchmaking fails during the same window.`,
	...
	'cheats-2026': {
		title: 'Fortnite Cheats 2026 | Best Hacks with ESP & ',
		description:
			'Best fortnite cheats 2026: ESP boxes, soft aim, and for Windows PC. Undetected fortnite cheats with EAC maintenance — compare and buy.',
		h1: 'Fortnite Cheats 2026 — ESP, Soft Aim & ',
		intro:
		...
		sections: [
			section(
				'Why fortnite cheats buyers choose Fortnite Cheats in 2026',
				...
				'Monthly ($35) and lifetime ($150) plans cover raid and zero-build loops — see <a href="/pricing/">Pricing</a>.',
			),
			section(
				'Full feature stack for 2026 buyers',
				'Player ESP wallhack, chest markers, 2D radar overlays, Aimbot profiles, in-client toggles, and post-patch rebuilds — one license instead of stacking separate tools.',
				'Deep links: <a href="/fortnite-cheats/">Fortnite cheats pillar</a>, <a href="/fortnite-esp/">ESP</a>, <a href="/fortnite-aimbot/">Aimbot</a>, <a href="/fortnite-wallhack/">wallhack</a>, <a href="/fortnite-radar-hack/">radar</a>, <a href="/undetected-fortnite-cheats/">undetected</a>.',
	...
	hacks: {
		title: 'Fortnite Cheats 2026 | Undetected ESP Aimbot Guide',
		description:
			'Fortnite cheats for Windows PC: undetected ESP wallhack, radar hack, and Aimbot with EAC maintenance. Compare fortnite cheats options and buy the full package.',
		h1: 'Fortnite Cheats — Undetected ESP, Aimbot & Wallhack',
		intro:
			'Fortnite cheats for raid and zero-build combine ESP wallhack visibility, 2D radar-style threat cues, and Aimbot controls in one undetected Windows PC license — maintained after Easy Anti-Cheat patches. This is the pillar guide for fortnite cheats in 2026.',
		imageAlt: 'fortnite cheats',
		galleryTitle: 'Fortnite cheats gallery — ESP, Aimbot, wallhack',
		ctaPrimary: 'Buy Fortnite Cheats',
		ctaSecondary: 'See undetected guide',
		ctaSecondaryHref: '/undetected-fortnite-cheats/',
		sections: [
			section(
				'What Fortnite cheats include in 2026',
				'Players searching for Fortnite cheats usually want visibility and combat tools without stacking separate downloads. Fortnite Cheats bundles player ESP wallhack, chest markers, 2D radar overlays, and configurable Aimbot in one maintained package — the same toolkit often called fortnite cheats.',
				'Coverage spans raid and zero-build with in-client toggles for live matches. Monthly ($35) and lifetime ($150) licenses unlock the full stack.',
			...
			section(
				'Fortnite cheats vs fortnite cheats — same stack, clear pages',
				'Searchers use fortnite cheats and fortnite cheats interchangeably. This pillar focuses on hacks language; the <a href="/fortnite-cheats-2026/">fortnite cheats 2026</a> and <a href="/best-fortnite-cheats/">best Fortnite cheats</a> pages cover buyer comparisons in cheats wording.',
				...
				'Blog guides expand Easy Anti-Cheat keyword: <a href="/blog/fortnite-cheats-complete-guide-2026/">hacks complete guide</a>, <a href="/blog/escape-from-fortnite-cheats-buyers-guide/">cheats buyers guide</a>, and <a href="/blog/undetected-fortnite-cheats-eac/">undetected Easy Anti-Cheat notes</a>.',
			),
			section(
				'Fortnite cheats vs single-feature tools',
			...
			section(
				'Undetected Fortnite cheats with EAC maintenance',
				'Undetected Fortnite cheats require rebuilds after Easy Anti-Cheat and major Fortnite patches. Check Updates before queueing — maintenance notes confirm when a new build is live. No package can promise permanent undetected status.',
				`See ${EXT.eac} for anti-cheat background and our <a href="/eac-bypass/">EAC bypass guide</a> for the practical workflow. Pair with <a href="/undetected-fortnite-cheats/">undetected Fortnite cheats</a> for status language buyers expect.`,
	...
	'cheat-download': {
		...
		description:
			'Fortnite cheat download with instant license delivery — ESP boxes, soft aim, and for Windows PC. Buy, activate, and play.',
		...
		imageAlt: 'fortnite cheats download',
		...
		sections: [
			section(
				...
				`If Epic Games services are down, check ${EXT.status} before assuming a download failure.`,
			),
			section(
				'What your download unlocks',
				'Every Fortnite cheat download includes player ESP wallhack, loot and chest markers, 2D radar overlays, Aimbot profiles, and in-client toggles for Battle Royale and Zero Build.',
	...
	'mod-menu': {
		...
		description:
			'Fortnite mod menu for in-match toggles — ESP boxes, soft aim, radar, and on Windows PC. Undetected fortnite cheats package.',
		...
		imageAlt: 'fortnite cheats mod menu',
		...
		sections: [
			section(
				...
				'Toggle player outlines, chest markers, vehicle cues, and per-weapon Aimbot settings without alt-tabbing out of Fortnite.',
				'Control deep-dives: <a href="/fortnite-esp/">ESP</a>, <a href="/fortnite-aimbot/">Aimbot</a>, <a href="/fortnite-radar-hack/">radar</a>.',
			),
			section(
				'Mod menu categories for Battle Royale and Zero Build',
			...
			section(
				...
				'Fortnite mod menu behavior is rebuilt when Easy Anti-Cheat or major Fortnite updates land. Follow the <a href="/updates/">Updates page</a> and <a href="/eac-bypass/">EAC bypass guide</a> before queueing on patch days.',
	...
	'soft-aim': {
		...
		description:
			'Fortnite soft aim settings for natural tracking on Windows PC. Smoothness, FOV, and bone priority — included in our fortnite cheats with ESP boxes.',
		...
		imageAlt: 'fortnite cheats soft aim',
	...
	'best-cheats': {
		...
		description:
			'Best fortnite cheats for 2026: ESP boxes, soft aim, and EAC maintenance on Windows PC. Use this checklist before checkout.',
		...
		sections: [
			section(
				...
				'Fortnite Cheats covers raid and zero-build with in-client toggles and post-patch rebuilds.',
			...
			section(
				...
				'Look for player ESP wallhack, chest markers, 2D radar overlays, Aimbot profiles, hotkey toggles, and documented maintenance after Fortnite patches.',
				...
				'Module pages worth opening: <a href="/fortnite-esp/">ESP</a>, <a href="/fortnite-aimbot/">Aimbot</a>, <a href="/fortnite-cheats/">hacks</a>.',
			),
			section(
	...
	'aimbot-hack': {
		...
		description:
			'Fortnite aimbot hack with soft aim for Windows PC. FOV, bone priority, and hotkeys — bundled with ESP boxes in our fortnite cheats package.',
		...
		sections: [
			section(
				...
				'Smoothness, FOV, and sensitivity controls tune assist for Fortnite combat pace across Battle Royale and Zero Build.',
	...
	'esp-hack': {
		...
		description:
			'Fortnite ESP hack with player boxes and chest markers for Windows PC. Undetected fortnite cheats with — see overlays and buy.',
		h1: 'Fortnite ESP Hack — Player Boxes Guide',
		intro:
			'Fortnite ESP hack overlays for Fortnite — player outlines, vehicle threat cues, loot and chest markers with distance readouts across raid and zero-build.',
		imageAlt: 'fortnite cheats esp',
		...
		sections: [
			...
			section(
				...
				'Toggle player ESP hack, chest markers, chest pins, and vehicle cues independently so only BR-critical overlays stay active during rotations.',
				'Team and enemy colour coding supports Battle Royale and Zero Build.',
	...
	'unlock-all': {
		...
		description:
			'Fortnite unlock all explained vs real fortnite cheats — ESP boxes, soft aim, and for Windows PC. Know what you are buying.',
		...
		sections: [
			section(
				...
				'Fortnite Cheats focuses on in-match awareness — player ESP, chest markers, radar overlays, and configurable Aimbot — not account-wide cosmetic unlocks.',
			...
			section(
				...
				'ESP wallhack helps you spot enemy squads, vehicles, and chest loot during live matches. Radar hack adds flank awareness; Aimbot covers combat assist with smoothness and hotkey controls.',
				...
				'Related: <a href="/fortnite-cheats/">Fortnite cheats</a> and <a href="/best-fortnite-cheats/">best Fortnite cheats</a>.',
			),
			section(
	...
	refund: {
		...
		description:
			'Refund policy for Fortnite Cheats. Digital delivery terms and eligibility for fortnite cheats packages with ESP, soft aim, and .',
		h1: 'Refund Policy',
		intro:
	...
	terms: {
		...
		sections: [
			...
			section(
				...
				`Using cheats in Fortnite may violate ${EXT.activision} terms and result in account penalties. Fortnite Cheats provides maintenance but does not guarantee undetected status or account safety.`,
