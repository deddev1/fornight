#!/usr/bin/env node
/**
 * Ports the 8 posts from ../fortnite-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'fortnite-blog', 'src', 'content', 'posts');
const OUT = join(ROOT, 'src', 'data', 'blog', 'posts.generated.ts');

const CATEGORY_NAMES = {
	'battle-royale-meta': 'raid Meta',
	'zero-build-strategies': 'zero-build',
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'fortnite intel'],
...
const file = `/* Auto-generated by scripts/port-from-fortnite-blog.mjs — do not edit by hand. */
