...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-fortnitehacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'fortnite-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'fortnite-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'fortnite-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'fortnite-aimbot-skeleton.webp',
	},
	{
		source:
	...
	},
	{
		...
		file: 'fortnite-cheats-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'fortnite-battle-royale-combat',
	'fortnite-reboot-fight',
	'fortnite-cheats-aimbot',
	'fortnite-cheats-cover',
	'fortnite-cheats-esp-wallhack',
	'fortnite-cheats-hero',
	'fortnite-cheats-logo',
	'fortnite-cheats-package',
	'fortnite-header-art',
	'fortnite-loadout-builder',
	'fortnite-player-esp',
	'fortnite-zero-build-combat',
	'fortnite-zero-build-mode',
	'fortnite-squad-fight',
	'fortnite-verdansk-map',
];

async function removeOldFortniteImages() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'fortnite-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `fortnite-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'fortnite-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'fortnite-cheats-logo.png');
